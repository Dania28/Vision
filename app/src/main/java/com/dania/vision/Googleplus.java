...
public class Googleplus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle _savedInstanceState) {
        ...
        loginprogress.setMessage("Logging you in to Google Plus...");

        loginprogress.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        loginprogress.setIcon(R.drawable.googleplusround);
    ...
    private void initializeLogic() {
        webview1.loadUrl("https://plus.google.com");
    }
