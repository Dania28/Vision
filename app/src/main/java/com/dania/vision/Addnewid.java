...
public class Addnewid extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addnewid);
    ...
    private void initailize() {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent fingerprint2 = new Intent(getApplicationContext(),fingerprint2.class);
                startActivity(fingerprint2);
            }
        });
